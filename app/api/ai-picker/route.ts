...
import { filterCarsClientSide } from "@/lib/picker/filters"
import type { Answer, CarPair, ChatMessage, ChatPreferences } from "@/lib/picker/types"
...
Поверни ТІЛЬКИ JSON.`,
    ...
    return {
      pairs: finalPairs.length > 0 ? finalPairs : prev.pairs,
...
//  → moved to lib/picker/filters.ts (filterCarsClientSide + OPTION_SYNONYMS)
// ═══════════════════════════════════════════════════════════════════════════════
