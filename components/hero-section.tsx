  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "linear-gradient(180deg, rgba(0,0,0,0.45) 0%, rgba(0,0,0,0.10) 30%, rgba(0,0,0,0.15) 60%, rgba(0,0,0,0.85) 100%)",
          zIndex: 2,
        }}
        aria-hidden="true"
      />
      ...
      >
        ...
        {/* Hero headline - Apple style: massive, clean, SF Pro feel */}
        <h1
        ...
        >
          {"Втілюй мрії разом"}
          <br />
          <span style={{ color: "#00D2C6" }}>{"з Fresh Auto"}</span>
        </h1>
        ...
        >
          {"Швидка покупка авто на вигідних умовах, з гарантією та оформленням."}
        </p>
        ...
        <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row">
          ...
          >
            <span className="relative z-10">{"Вибрати авто"}</span>
        ...
        <div className="mt-14 flex items-center justify-center gap-12 sm:gap-20">
          {[
            { value: "2 400+", label: "Авто" },
            { value: "14", label: "Країн" },
            { value: "<1 хв", label: "Відповідь" },
          ].map((stat, i) => (
