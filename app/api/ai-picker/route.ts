...
TRIGGER_SEARCH якщо (будь-яка з умов):
- Клієнт просить пошук або більше варіантів
- Клієнт дав марку/модель + будь-який додатковий параметр (рік, пробіг, кузов, паливо)
- Клієнт уточнив параметри відповідаючи на твої питання
- Клієнт хоче альтернативи до каталогу
- Клієнт підтвердив параметри ("давай", "так", "добре", "більше")

ВАЖЛИВО: Максимум 2 уточнюючих питання за весь діалог. Якщо вже питав — запускай пошук.
