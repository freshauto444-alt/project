    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Fresh Auto — автомобілі з Європи під ключ',
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="uk" suppressHydrationWarning>
      <head>
        {/* Prevent flash of wrong theme — runs before paint, defaults to dark if no pref */}
        <script dangerouslySetInnerHTML={{ __html: `try{var t=localStorage.getItem("fa-theme");document.documentElement.className=(t==="light"?"light":"dark")}catch(e){document.documentElement.className="dark"}` }} />
