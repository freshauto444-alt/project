...
export default function LocationMap() {
  ...
  // Use Google Maps on server (SSR) and detect Apple on client (avoids hydration mismatch)
  ...
  useEffect(() => {
    ...
    if (ua.includes("iphone") || ua.includes("ipad") || ua.includes("macintosh")) {
      setDirectionsUrl(APPLE_MAPS_URL)
    }
  }, [])
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          >
            <a
              ...
              className="relative block aspect-[16/9] lg:aspect-[2/1] rounded-2xl overflow-hidden border border-border group cursor-pointer"
            >
              ...
              <div className="absolute inset-0 bg-card">
                <iframe
                  ...
                  className="w-full h-full border-0 pointer-events-none map-filter"
                  loading="lazy"
                />
              </div>
