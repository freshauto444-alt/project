...
D. У whyRecommended ЦІНИ НЕ ЗГАДУЙ — клієнт побачить реальні ціни вже на знайдених авто. Жодних "€X під ключ", "за €Xk", "коштує близько €X" тощо. Фокус — на характеристиках, перевагах, ринку.
...
КРАЩЕ:
  (a) Якщо ВКАЗАНО рік-from "2017+" клієнтом → суджестай "2017-2019" або "2017-2020" — старше покоління де реально є 15-30 варіантів у бюджеті. yearRange yearTo ставь там де реально вкладається.
  (b) Якщо ВКАЗАНО конкретний вузький рік → суджестай дешевшу модель того ж класу яка реально є у вказаному році в бюджеті.

ВАЖЛИВО ПРО yearRange: yearTo НЕ повинен бути жорстким лімітом — це AI-підказка коли реальні варіанти у бюджеті закінчуються. yearFrom = найстарший прийнятний рік (з врахуванням комплекту і пробігу). yearTo = найновіший де ще можливо вкластись у бюджет. Якщо клієнт вказав yearFrom=2017, але реальні авто в бюджеті є до 2021 → суджестай "2017-2021". Не звужуй до "2018-2020" штучно.
