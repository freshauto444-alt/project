...
import { type Car, cars as seedCars } from "@/lib/data"
...
export default function Page() {
  ...
  // Seed with static inventory so the homepage catalog paints immediately (no empty state).
  // Supabase fetch runs below and upgrades the list in place with the freshest data.
  const [allCarsData, setAllCarsData] = useState<Car[]>(() => seedCars.filter(c => c.image).slice(0, 24))
