      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "@id": "https://freshauto.ua#org",
            name: "Fresh Auto",
            url: "https://freshauto.ua",
            image: "https://freshauto.ua/og.jpg",
            ...
            contactPoint: [
              { "@type": "ContactPoint", telephone: "+380987081919", contactType: "sales", name: "Ігор Юрійович", availableLanguage: ["uk", "en"] },
              { "@type": "ContactPoint", telephone: "+380678160505", contactType: "customer support", name: "Руслан Петрович", availableLanguage: ["uk", "en"] },
            ],
          }),
        }}
      />
