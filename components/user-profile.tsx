              ...
              <div className="flex flex-col gap-3">
                {recentActivity.map((item, i) => (
                  <div key={i} className="flex items-center gap-3 rounded-xl bg-secondary/30 p-3">
                    ...
                    <span className="text-xs font-semibold text-primary flex-shrink-0">{formatPrice(item.price)}<span className="text-[9px] font-normal text-muted-foreground/70 ml-1">під ключ</span></span>
                  </div>
                ))}
              </div>
            </div>
                ...
                <div key={i} className="flex items-center gap-4 rounded-2xl border border-border bg-card p-4 hover:border-primary/20 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm font-bold text-primary mt-1">
                      ...
                      <span className="ml-1 text-[9px] font-normal text-muted-foreground/70">під ключ</span>
                    </p>
                  </div>
                  <button
