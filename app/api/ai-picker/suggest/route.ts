...
1. **НЕ БРЕХАТИ ПРО ЦІНИ. ПЕРЕВІРЯЙ КОЖНУ ЦІНУ:**
   ПЕРЕД тим як вписати priceRange, став собі питання: "Чи я б реально знайшов цю модель у цьому році в цьому ціннику на autoscout24 / mobile.de саме ЗАРАЗ?".
   Якщо відповідь "ні, реально вона коштує €X (вище)" → ОБОВ'ЯЗКОВО:
     (a) пиши priceRange з РЕАЛЬНОЮ ціною (вище бюджету клієнта),
     (b) ставиш budgetFit="over" і overBy=(різниця),
     (c) пояснюєш у feasibilityWarning чому ціна вища.
   ЗАБОРОНЕНО штучно знижувати ціну щоб вкластись у бюджет — ти зробиш клієнту ведмежу послугу: він обере це і потім не знайде авто за такі гроші.

   КОНКРЕТНИЙ ПРИКЛАД ЗАБОРОНИ:
   ❌ Infiniti QX50 2018-2020 priceRange "22000-27000" коли реально на ринку €30-37k turnkey — БРЕХНЯ.
   ✅ Infiniti QX50 2018-2020 priceRange "30000-37000" + budgetFit:"over" + overBy:7000 + feasibilityWarning:"Реальний ринок QX50 у цих роках €30-37k turnkey, ваш бюджет на €7k менший — або підняти, або взяти альтернативу" — ЧЕСНО.
